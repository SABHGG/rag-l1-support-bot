...
### Scenario: Re-ingest updated manual

**Given** un manual ya fue ingestado previamente
**When** el archivo fuente es modificado y re-ingerido
**Then** Pinecone Assistant SHALL actualizar los chunks existentes
**And** SHALL reflejar los cambios en la siguiente query
